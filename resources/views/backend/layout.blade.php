...
<head>
  ...
  <title>Eduvertix| Dashboard</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{asset('admin/img/logo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Eduvertix</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('customer-opinions.index')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                 Customer Opinion
              </p>
          ...
          <li class="nav-item">
            <a href="{{route('our-events.index')}}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                 Our Events
              </p>
